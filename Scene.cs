...
namespace BallCollision
{
    public class Scene
    {
        ...
        {
            PlayerBall.Move(new Point(PlayerBall.Center.X - 10, PlayerBall.Center.Y));
        }
        ...
        public void MoveUp()
        {
            PlayerBall.Move(new Point(PlayerBall.Center.X, PlayerBall.Center.Y - 10));
        }
        public void MoveDown()
        {
            PlayerBall.Move(new Point(PlayerBall.Center.X, PlayerBall.Center.Y + ));
        }
    }
}
